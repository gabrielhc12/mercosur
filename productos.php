...
<center id="aea">
	<br>	
	<br>
	<h1>Agregar nuevo producto de exportación</h1>
	<div id="form">
		<form method="post">
			<table width="100%" border="1" cellpadding="6">
				...
				<tr>
					<td>
						<input type="text" name="descripcion"placeholder="Descripcíon"value="<?php if(isset($_GET['edit'])) echo $getROW['descripcion'];?>">
					</td>
				</tr>
				<tr>
					<td>
			...
			<thead class="table-dark">
				...
				while($row=$res->fetch_array()){
					...
					<tr class="text-white">
						...
						<td><a href="?edit=<?php echo $row['id_productos'];?>"onclick="return confirm('Confirmar edicion')">Editar</a></td>
						<td><a href="?del=<?php echo $row['id_productos'];?>"onclick="return confirm('Confirmar eliminacion')">Eliminar</a></td>
